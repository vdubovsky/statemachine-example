...
import static io.vdubovsky.statemachineexample.statemachine.configuration.StateMachine1FactoryConfiguration.MACHINE_ID;

@Configuration
@RequiredArgsConstructor
@EnableStateMachineFactory(name = MACHINE_ID)
public class StateMachine1FactoryConfiguration extends StateMachineConfigurerAdapter<String, String> {
    final static String MACHINE_ID = "PROCESS_1_";
